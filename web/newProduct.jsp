                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="AddProductServlet" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="input-1" name="ID" placeholder="Nhập id phim">
                                        </div>
                                        <div class="form-group">
                                            <label for="input-2">Tên phim</label>
                                            <input type="text" class="form-control" id="input-2" name="name" placeholder="Nhập tên phim">
                                        </div>
                                        <div class="form-group">
                                            <label for="input-3">Thể loại</label>
                                            <input type="text" class="form-control" id="input-3" name="type" placeholder="Nhập thể loại phim">
                                        </div>
                                        <div class="form-group">
                                            <label for="input-4">Giá phim</label>
                                            <input type="text" class="form-control" id="input-4" name="price" placeholder="Giá muốn bán">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="input-4">Mô tả (nếu có)</label>
                                            <input type="text" class="form-control" id="input-6" name="description" placeholder="Mô tả">
                                        </div>
                                        <div class="form-group">
                                            <label for="input-7">Thể loại phim</label>
                                            <input type="text" class="form-control" id="input-7" name="typeid" placeholder="Chọn thể loại phim">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-light px-5"><i class="fa fa-plus"></i> Thêm phim</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
