<%-- 
    Document   : Login
    Created on : 12 thg 12, 2023, 11:23:52
    Author     : lengocloc
--%>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            <h2>Lần đầu đến Louis Trân ?</h2>
                            <p>Chúng tôi cung cấp các sản phẩm thời trang hàng đầu thế giới với chất lượng đã được chứng minh qua 100 năm</p>
                            <a href="Signup.jsp" class="btn_3">Đăng Ký</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                            ...
                            <form class="row contact_form" action="LoginServlet" method="POST" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="creat_account d-flex align-items-center">
                                        ...
                                        <label for="f-option">Ghi nhớ tôi</label>
                                    </div>
