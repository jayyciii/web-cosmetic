            ...
            <tbody>
              ...
              <tr>
                <td>
                  <div class="media">
                    <div class="d-flex">
                        <img src="${cart.image}" alt="" style="height: 240px;" />
                    </div>
                    <div class="media-body">
<!--                      <p>Day la mo ta san pham</p>-->
                    </div>
                  </div>
                </td>
                <td>
          ...
          <div class="checkout_btn_inner float-right">
            ...
            <a class="btn_1 checkout_btn_1" href="${pageContext.request.contextPath}/payment-servlet">Thanh toán online</a>
          </div>
        </div>
      </div>
  </section>
