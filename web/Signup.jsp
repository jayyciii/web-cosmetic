                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Chào bạn mới !<br>
                                Tạo tài khoản ngay</h3>
                            <form class="row contact_form" method="POST" action="SignupServlet" novalidate="novalidate">
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="name" name="username" value=""
                                        placeholder="Username">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="name" name="gender" value=""
                                        placeholder="Gender">
                                </div>
                                <div class="col-md-12 form-group p_star">
